...
def player_stats(name):
    ...
    player_data = player_data.style.hide(['player_id','player_name','player_display_name','position','position_group','headshot_url','season','season_type'], axis="columns").hide(axis="index")
...
def team_schedule(team, fullname):
    ...
    full_schedule = full_schedule.style.hide(axis="index").hide(['season','game_type','location','old_game_id','gsis','nfl_detail_id','pfr','pff','espn','away_qb_id','home_qb_id','stadium_id'], axis="columns")
...
def team_fpa(team, fullname):
    ...
    full_schedule = full_schedule.style.hide(axis="index").hide(['season','game_type','location','old_game_id','gsis','nfl_detail_id','pfr','pff','espn','away_qb_id','home_qb_id','stadium_id','temp','wind','is_home'], axis="columns")
